        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              In the ever-evolving world of technology, I believe in continuous learning, innovation, and the power of collaboration. <b className="purple">Let’s build the future—one line of code at a time! 🚀</b>
              <i>
